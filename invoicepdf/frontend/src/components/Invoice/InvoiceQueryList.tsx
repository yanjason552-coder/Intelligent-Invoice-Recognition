  ...
  const fetchData = async () => {
    ...
    try {
      ...
      postDebugLog({
        runId: 'pre-run',
        hypothesisId: 'H11',
        location: 'InvoiceQueryList.tsx:fetchData',
        message: 'fetch invoices query',
        data: { apiBaseUrl, params, reviewStatus, searchKeyword: searchKeyword?.slice(0, 80) }
      })
      ...
      if (response.data && response.data.data) {
        ...
        postDebugLog({
          ...
          hypothesisId: 'H11',
          location: 'InvoiceQueryList.tsx:fetchData',
          message: 'fetch invoices query success',
        ...
        postDebugLog({
          ...
          hypothesisId: 'H11',
          location: 'InvoiceQueryList.tsx:fetchData',
          message: 'fetch invoices query empty',
      ...
      postDebugLog({
        ...
        hypothesisId: 'H11',
        location: 'InvoiceQueryList.tsx:fetchData',
        message: 'fetch invoices query error',
