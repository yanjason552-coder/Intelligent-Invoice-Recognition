import { Box, Text, Flex, VStack, HStack, Input, Badge, IconButton, Divider } from "@chakra-ui/react"
import { FiSave, FiX, FiPlus, FiTrash2, FiEdit2, FiEye } from "react-icons/fi"
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        // 更新模板
        await axios.put(`/api/v1/templates/${templateId}`, formData, {
          headers: token ? { Authorization: `Bearer ${token}` } : {}
        })
    ...
    <Box p={6} h="100vh" display="flex" flexDirection="column" overflow="auto">
      ...
      <Flex justify="space-between" align="center" mb={4}>
        ...
        <HStack spacing={2}>
          ...
          <Button
            onClick={() => {
              const event = new CustomEvent('closeTab', { detail: { tabId: 'template-edit' } })
